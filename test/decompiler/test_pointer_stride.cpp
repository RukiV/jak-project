...
// *car-upgrade-info* extern is typed (pointer car-upgrade-info-array), a
// plain (non-boxed) pointer to a reference-typed structure whose only field
// is a nested inline array (car-upgrade-info-array -> upgrade-info-array x15
// -> upgrade-info x4). get_deref_info models a non-boxed pointer to a
