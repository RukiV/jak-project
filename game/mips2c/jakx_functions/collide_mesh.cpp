...
void link() {
  ...
  gLinkedFunctionTable.reg("(method 12 collide-mesh)", execute, 0);
}

} // namespace method_12_collide_mesh
} // namespace Mips2C
// add method_12_collide_mesh::link to the link callback table for the object file.
// FWD DEC:
...
void link() {
  gLinkedFunctionTable.reg("(method 14 collide-mesh)", execute, 0);
}

} // namespace method_14_collide_mesh
} // namespace Mips2C
// add method_14_collide_mesh::link to the link callback table for the object file.
// FWD DEC:
